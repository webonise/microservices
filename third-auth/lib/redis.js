...
setInterval(function() {  // Don't let a cached client get too stale.
  ...
  }                       // bookkeeping. New connections are cheap-ish.)
}, 1000).unref();
...
var createToken = func.createToken = function createToken(platform, platformId) {
  ...
  return Promise.all([
    withRedis(function applyCreateTokenUuid(client) {
      return client.set(uuid, platKey);
    }),
    withRedis(function applyCreateTokenClientId(client) {
      return client.set(platKey, uuid);
    })
